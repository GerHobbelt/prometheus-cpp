...
/// https://core.io/docs/instrumenting/writing_clientlibs/#summary
///
...
/// server side:
/// https://core.io/docs/prometheus/latest/querying/functions/#histogram_quantile.
///
/// Note that Phi designates the probability density function of the standard
/// Gaussian distribution.
///
/// See https://core.io/docs/practices/histograms/ for detailed
